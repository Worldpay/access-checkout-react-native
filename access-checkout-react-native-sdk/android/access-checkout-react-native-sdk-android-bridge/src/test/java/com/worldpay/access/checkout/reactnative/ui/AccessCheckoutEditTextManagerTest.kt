...
internal class AccessCheckoutEditTextManagerTest {
    private val manager = AccessCheckoutEditTextManager(reactApplicationContext())
    ...
    fun `getName() should return the name of the react class`() {
        val expectedName = "AccessCheckoutEditText"
