package com.worldpay.access.checkout.reactnative.instrumentation.services.ssl.client
...
class TrustAllSSLSocketFactory : SSLSocketFactory() {
    ...
    companion object {
        private val DEFAULT_CIPHER_SUITES =
            HttpsURLConnection.getDefaultSSLSocketFactory().defaultCipherSuites
