...
JEST_HTML_REPORTER_OUTPUT_PATH="./reports/e2e-tests/android-e2e-tests.html" detox test --configuration android-ci --loglevel debug --take-screenshots all --record-logs all
status=$?
